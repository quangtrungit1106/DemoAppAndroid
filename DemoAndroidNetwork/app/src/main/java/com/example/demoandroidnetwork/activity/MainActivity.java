...
public class MainActivity extends AppCompatActivity {
    ...
    List<WeatherForecastModel> weatherForecastModels = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        weatherAdapter = new WeatherAdapter(this, weatherForecastModels);
...
//Log.d("AAA",""+conditionicon);
                            ...
                            for (int i=0;i< hourArray.length();i++)
                            {
                                ...
                                Log.d("AAA"," "+time+" "+temper+" "+img+" "+wind);
                                        weatherForecastModels.add(new WeatherForecastModel(time,temper,img,wind));
                            }
                            weatherAdapter.notifyDataSetChanged();
